...
const resourcesArray = [
  { title: "/products", href: "/api/products", total: "20 products" },
  { title: "/posts", href: "/api/posts", total: "100 posts" },
  {
    title: "/comments",
    href: "/api/comments",
    total: "500 comments",
  },
  { title: "/albums", href: "/api/albums", total: "100 albums" },
  { title: "/photos", href: "/api/photos", total: "5000 photos" },
  { title: "/todos", href: "/api/todos", total: "200 todos" },
  { title: "/users", href: "/api/users", total: "10 users" },
];
